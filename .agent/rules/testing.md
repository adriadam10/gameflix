...
- **SSH Access**: There is a Batocera machine available for testing via the ssh alias "batocera". You can run commands on the target machine using `ssh batocera <command>`.
