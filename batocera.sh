...
if [ ! -f /userdata/system/git ];  then wget -O /userdata/system/git  https://github.com/adriadam10/gameflix/raw/main/batocera/share/system/git; chmod +x /userdata/system/git; mv /userdata/system/git /bin; fi
